...
const StateDetails = () => {
  ...
  const { data: state, isLoading, isError, error } = useGetStateQuery(id);
  const [deleteState, { isSuccess, isLoading: isDelLoading, isError: isDelError, error: delError }] = useDeleteStateMutation();
